...
//
    ...
    public void desactivarbotones() {
        ...
        vista.getTxtnombrecarrera().setEnabled(false);
    ...
    public void activarbotones() {
        ...
        vista.getTxtnombrecarrera().setEnabled(true);
    ...
    public void guardar() {
        ...
        String view = "";
        view = carrera.verificarCodCarrera(codigo);
        if (view != "") {
            JOptionPane.showMessageDialog(null, "Còdigo ya existe!", "\n Verifique", 0);
            vista.getTxtCodigo_carrera().setText("");
        }
        if (view == "") {
            carrera.setNombre_carrera(vista.getTxtnombrecarrera().getText());
...
//        System.out.println(codigo);
        ...
        vista.getTxtnombrecarrera().setText(carrera.getNombre_carrera());
    ...
    public void nuevo() {
        ...
        activarbotones();
        vista.getTxtCodigo_carrera().setText("");
        vista.getTxtnombrecarrera().setText("");
